...
Public Class Sales_System_McDonalds
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If currentURL = "https://ev.pcsb.org/sales_system_mcdonalds.aspx?passprnt_code=0&passprnt_message=SUCCESS" Then
    ...
    Sub EnterSale()
        ...
        con.Close()
        SqlConnection.ClearAllPools()
        Response.Redirect("./Print_Sales.aspx?b=" & AccountNumber)
    End Sub
