<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Duke_Meter_Checklist.aspx.vb" %>
...
<meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0; maximum-scale=2.0; user-scalable=0;">
          <title>Duke Energy Meter Reader Checklist</title>
...
<body>
        ...
        <table class="tall_table" border="1" >
            <tbody>
              <tr>
                ...
                <td class="table_header2">Meter Reading</td>
                <td class="table_header2">Entered on Manager's Checklist</td>
                <td class="table_header2">Delivered Bill</td>
                <td class="table_header2">Collected Check</td>
              </tr>
              <tr>
    ...
    <div class="second">
      <ul>
      <li><h4>Enter the reading of the meter for each business.</h4></li>
    </ul>
    </div>
