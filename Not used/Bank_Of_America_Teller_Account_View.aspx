<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Bank_Of_America_Teller_Account_View.aspx.vb" Inherits="Enterprise_Village_2._0.Bank_Of_America_Teller_Account_View" %>
...
<body>
    ...
    <div class="header2">
     ...
     <div class="main_boa">
         ...
         <p>Account Search</p>
         <asp:TextBox ID="Student_account_Number" runat="server" TextMode="Number" MaxLength="3" Width="75px" ></asp:TextBox>
         <asp:Button ID="Account_search" runat="server" Text="Search" />
             </div>
         <div class="Business_name">
    ...
    <div class="second">
      ...
      <li><h4>Goals:Prevent field from being modified after 1st submission.</h4></li>
      <li><h4>Account search page also created if needed</h4></li>
