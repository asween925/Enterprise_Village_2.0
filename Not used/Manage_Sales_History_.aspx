<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Manage_Sales_History_.aspx.vb" Inherits="Enterprise_Village_2._0.Manage_Sales_History_" %>
     ...
     <div class="main_ups">
         ...
         <div class="Account_area">
            <div class="Employee_summary">
                ...
                <asp:GridView ID="Sales_dgv" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="True" CellPadding="5" CellSpacing="1" PageSize="20" DataKeyNames="ID">
