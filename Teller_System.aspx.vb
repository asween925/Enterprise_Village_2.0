...
Public Class Teller_System
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If currentURL = "https://ev.pcsb.org/teller_system.aspx?passprnt_code=0&passprnt_message=SUCCESS" Then
    ...
    Sub EnterDeposit()
        ...
        Response.Redirect("./Print_Teller.aspx?b=" & URLEnd & "&b2=" & checkAmountIndex & "&b3=" & cashIndex)
    End Sub
    ...
    Sub OpenSavingsAccount()
        ...
        If Savings_lbl.Text = "0.00" Then
            ...
            Try
                ...
                Response.Redirect("./Print_Teller_Savings.aspx?b=" & empID & "&b2=" & savingsAmountIndex)
