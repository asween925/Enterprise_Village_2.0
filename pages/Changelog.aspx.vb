...
Public Class Changelog
	...
	Protected Sub v2221_btn_Click(sender As Object, e As EventArgs) Handles v2221_btn.Click
		RevealDiv(v2221_div)
	End Sub

	Protected Sub v2222_btn_Click(sender As Object, e As EventArgs) Handles v2222_btn.Click
		RevealDiv(v2222_div)
	End Sub
End Class