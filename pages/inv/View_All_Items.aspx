<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="View_All_Items.aspx.vb" Inherits="Enterprise_Village_2._0.View_All_Items" %>
...
<body>
    <form id="EMS_Form" runat="server">
        ...
        <div class="content">
            <h2 class="h2 no-print">View All Items</h2>
            ...
            <br /><br />
                ...
                <%--Items Table--%>
                 <div>
                        <asp:GridView ID="items_dgv" runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="false" DataKeyNames="ID" CellPadding="5" Height="50" AllowPaging="True" ShowHeaderWhenEmpty="True" Font-Size="Medium" Visible="true" PageSize="300" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows">
                            <Columns>
