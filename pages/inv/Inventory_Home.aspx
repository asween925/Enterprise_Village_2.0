    ...
    <form autocomplete="off"  id="EMS_Form" runat="server">
        ...
        <div class="content_home">
            ...
            <div class="button_grid__inv">
                ...
                <div class="button_item2">
                    <br />
                        <asp:LinkButton ID="LinkButton4" runat="server" PostBackUrl="~/pages/inv/add_remove_amount.aspx" CssClass="button_inv_home">Add / Remove On Hand Amount</asp:LinkButton><br />
                </div>
                <div class="button_item2">
                    <br />
                ...
                <div class="button_item2">
                    <br />
                        <asp:LinkButton ID="LinkButton5" runat="server" PostBackUrl="/pages/student/manager_system.aspx?b=11" CssClass="button_inv_home">Ditek Manager System</asp:LinkButton><br />
                </div>
                <div class="button_item2">
                    <br />
                        <asp:LinkButton ID="homePage_btn" runat="server" PostBackUrl="/pages/home_page.aspx" CssClass="button_inv_home" Visible="true">EV 2.0 Home Page</asp:LinkButton><br />
                </div>
            </div>
        </div>
