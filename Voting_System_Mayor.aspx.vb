...
Public Class Voting_System_Mayor
    ...
    Sub LoadData()
        ...
        Dim SQLStatement As String = "SELECT q1a1, q1a2, q1a3, q1a4, q2a1, q2a2, q2a3, q2a4, q3a1, q3a2, q3a3, q3a4, q4a1, q4a2, q4a3, q4a4, q5a1, q5a2, q5a3, q5a4 FROM voting WHERE visitID = '" & VisitID & "'"
        ...
        Q1A1Per = Q1A1 / (Q1A1 + Q1A2) * 100
        Q1A2Per = Q1A2 / (Q1A1 + Q1A2) * 100
        'Q1A3Per = Q1A3 / TotalVotes * 100
        'Q1A4Per = Q1A4 / TotalVotes * 100
        'Q2A1Per = Q2A1 / TotalVotes * 100
        Q2A2Per = Q2A2 / (Q2A2 + Q2A3) * 100
        Q2A3Per = Q2A3 / (Q2A2 + Q2A3) * 100
        'Q2A4Per = Q2A4 / TotalVotes * 100
        Q3A1Per = Q3A1 / TotalVotes * 100
        Q3A2Per = Q3A2 / TotalVotes * 100
        Q3A3Per = Q3A3 / TotalVotes * 100
        Q3A4Per = Q3A4 / TotalVotes * 100
        'Q4A1Per = Q4A1 / TotalVotes * 100
        Q4A2Per = Q4A2 / (Q4A2 + Q4A3) * 100
        Q4A3Per = Q4A3 / (Q4A2 + Q4A3) * 100
        'Q4A4Per = Q4A4 / TotalVotes * 100
        Q5A1Per = Q5A1 / (Q5A1 + Q5A2) * 100
        Q5A2Per = Q5A2 / (Q5A1 + Q5A2) * 100
        'Q5A3Per = Q5A3 / TotalVotes * 100
        'Q5A4Per = Q5A4 / TotalVotes * 100

        q1a1_lbl.Text = Q1A1Per & "%"
        q1a2_lbl.Text = Q1A2Per & "%"
        'q1a3_lbl.Text = Q1A3Per & "%"
        'q1a4_lbl.Text = Q1A4Per & "%"
        'q2a1_lbl.Text = Q2A1Per & "%"
        q2a2_lbl.Text = Q2A2Per & "%"
        q2a3_lbl.Text = Q2A3Per & "%"
        'q2a4_lbl.Text = Q2A4Per & "%"
        q3a1_lbl.Text = Q3A1Per & "%"
        q3a2_lbl.Text = Q3A2Per & "%"
        q3a3_lbl.Text = Q3A3Per & "%"
        q3a4_lbl.Text = Q3A4Per & "%"
        'q4a1_lbl.Text = Q4A1Per & "%"
        q4a2_lbl.Text = Q4A2Per & "%"
        q4a3_lbl.Text = Q4A3Per & "%"
        'q4a4_lbl.Text = Q4A4Per & "%"
        q5a1_lbl.Text = Q5A1Per & "%"
        q5a2_lbl.Text = Q5A2Per & "%"
        'q5a3_lbl.Text = Q5A3Per & "%"
        'q5a4_lbl.Text = Q5A4Per & "%"
