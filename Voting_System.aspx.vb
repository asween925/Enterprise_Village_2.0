...
Public Class Voting_System
    ...
    Sub SubmitVoting()
        ...
        If q1a1_rdo.Checked = False And q1a2_rdo.Checked = False Then
        ...
        If q2a2_rdo.Checked = False And q2a3_rdo.Checked = False Then
            questionsError_lbl.Text = "Please answer question #2 before casting your vote."
            Exit Sub
        End If

        If q3a1_rdo.Checked = False And q3a2_rdo.Checked = False And q3a3_rdo.Checked = False And q3a4_rdo.Checked = False Then
        ...
        If q4a2_rdo.Checked = False And q4a3_rdo.Checked = False Then
        ...
        If q5a1_rdo.Checked = False And q5a2_rdo.Checked = False Then
        ...
        SQLInsert = "INSERT INTO voting (visitID, visitDate, q1a1, q1a2, q2a2, q2a3, q3a1, q3a2, q3a3, q3a4, q4a2, q4a3, q5a1, q5a2) VALUES ('" & VisitID & "', '" & Date.Today.ToShortDateString & "', '" & CountVotes.Q1A1 & "', '" & CountVotes.Q1A2 & "', '" & CountVotes.Q2A2 & "', '" & CountVotes.Q2A3 & "', '" & CountVotes.Q3A1 & "', '" & CountVotes.Q3A2 & "', '" & CountVotes.Q3A3 & "', '" & CountVotes.Q3A4 & "', '" & CountVotes.Q4A2 & "', '" & CountVotes.Q4A3 & "', '" & CountVotes.Q5A1 & "', '" & CountVotes.Q5A2 & "')"
        ...
        SQLUpdate = "UPDATE voting SET q1a1=q1a1+'" & CountVotes.Q1A1 & "', q1a2=q1a2+'" & CountVotes.Q1A2 & "', q2a2=q2a2+'" & CountVotes.Q2A2 & "', q2a3=q2a3+'" & CountVotes.Q2A3 & "', q3a1=q3a1+'" & CountVotes.Q3A1 & "', q3a2=q3a2+'" & CountVotes.Q3A2 & "', q3a3=q3a3+'" & CountVotes.Q3A3 & "', q3a4=q3a4+'" & CountVotes.Q3A4 & "', q4a2=q4a2+'" & CountVotes.Q4A2 & "', q4a3=q4a3+'" & CountVotes.Q4A3 & "', q5a1=q5a1+'" & CountVotes.Q5A1 & "', q5a2=q5a2+'" & CountVotes.Q5A2 & "' WHERE visitID = '" & VisitID & "'"
    ...
    Function CountVotes() As (Q1A1 As Integer, Q1A2 As Integer, Q1A3 As Integer, Q1A4 As Integer, Q2A1 As Integer, Q2A2 As Integer, Q2A3 As Integer, Q2A4 As Integer, Q3A1 As Integer, Q3A2 As Integer, Q3A3 As Integer, Q3A4 As Integer, Q4A1 As Integer, Q4A2 As Integer, Q4A3 As Integer, Q4A4 As Integer, Q5A1 As Integer, Q5A2 As Integer, Q5A3 As Integer, Q5A4 As Integer)
        ...
        Return (Q1A1, Q1A2, Q1A3, Q1A4, Q2A1, Q2A2, Q2A3, Q2A4, Q3A1, Q3A2, Q3A3, Q3A4, Q4A1, Q4A2, Q4A3, Q4A4, Q5A1, Q5A2, Q5A3, Q5A4)
