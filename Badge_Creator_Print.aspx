    ...
    <form id="Profit_display_Form" runat="server">
        <div id="site_wrap">
            <div class="main_mix">
                ...
                <br />
                <asp:LinkButton ID="LinkButton9" runat="server" PostBackUrl="/badge_creator_history.aspx" Font-Size="Medium" CssClass="button button1 no-print">Badge History</asp:LinkButton>
                <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="/badge_creator.aspx" Font-Size="Medium" CssClass="button button1 no-print">Badge Creator</asp:LinkButton>
                <br /><br />
                <%--Printed Badges--%>
