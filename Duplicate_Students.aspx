...
<body>
    <form id="EMS_Form" runat="server">
        ...
        <div class="content">
            ...
            <asp:LinkButton ID="LinkButton" runat="server" PostBackUrl="~/Employee_Management_System_Review.aspx" CssClass="button3" Text="Employee Management System"></asp:LinkButton>
            <br />
            <p>Visit Date:</p>
