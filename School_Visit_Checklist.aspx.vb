...
Public Class School_Visit_Checklist
    ...
    Sub Step2()
        ...
        If invoice_chk.Checked = True And director_chk.Checked = True Then
            ...
            step2Msg_lbl.Text = ""
            error_lbl.Text = "Submission Successful! Opening email and refreshing page..."
            ScriptManager.RegisterStartupScript(Me.Page, Me.Page.[GetType](), "OpenEmail", "javascript:window.location.href='mailto:russells@pcsb.org ?subject=School Visit Checklist: Invoice Number and Signature Received&cc=fritzs@pcsb.org&body=I have gotten the invoice number and directors signature for " & schoolName_lbl.Text & " visiting on " & visitDate_lbl.Text & ". Time completed: " & DateTime.Now & " ';", True)
    ...
    Sub Step4()
        ...
        If numOfKits_ddl.SelectedIndex <> 0 Then
            ...
            step3Msg_lbl.Text = ""
            error_lbl.Text = "Submission Successful! Opening email and refreshing page..."
            ScriptManager.RegisterStartupScript(Me.Page, Me.Page.[GetType](), "OpenEmail", "javascript:window.location.href='mailto:fritzs@pcsb.org ?subject=School Visit Checklist: Kit Numbers Submitted&cc=russells@pcsb.org&body=I have completed the submission of the amount of kits being sent out and the number each kit for " & schoolName_lbl.Text & " on " & visitDate_lbl.Text & ". Time completed: " & DateTime.Now & " ';", True)
