<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Print_Teller.aspx.vb" Inherits="Enterprise_Village_2._0.Print_Teller" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
            ...
            function PrintFromURL() {
                ...
                tellerURL = "https://ev.pcsb.org/teller_system.aspx"
        ...
        function GoBackToTeller() {
            window.location.replace("https://ev.pcsb.org/teller_system.aspx")
        }
...
<body onload="PrintFromURL();">
    <form id="Online_Banking_Form" runat="server">
        <div style="font-size: x-large;">
            <%--<img src="Images/Bank_of_America.png" alt="Bank of America logo" height="150" />--%>
            ...
            <p>Previous Balance: <asp:Label ID="balance_lbl" runat="server"></asp:Label></p>
            <p>Savings: <asp:Label ID="savings_lbl" runat="server"></asp:Label></p>
            <p>Check Amount Deposited: <asp:Label ID="checkAmount_lbl" runat="server"></asp:Label></p>
            <p>Cash Being Withdrawn: <asp:Label ID="cash_lbl" runat="server"></asp:Label></p>
            <p>Net Deposit: <asp:Label ID="netDeposit_lbl" runat="server"></asp:Label></p>
            <p>New Balance: <asp:Label ID="newBalance_lbl" runat="server"></asp:Label></p>
            <p>Deposit History:</p>
            <asp:Label ID="deposit1_lbl" runat="server"></asp:Label>
            <br />
            <asp:Label ID="deposit2_lbl" runat="server"></asp:Label>
            <br />
            <asp:Label ID="deposit3_lbl" runat="server"></asp:Label>
            <br />
            <asp:Label ID="deposit4_lbl" runat="server"></asp:Label><br />    
           <%-- <input type='button' value='Print' style="width:100px; height:50px" onclick='PrintFromURL()' />--%>
            <asp:DropDownList ID="Check_amount_ddl" runat="server" Visible="false" Font-Size="X-Large">
                            <asp:ListItem></asp:ListItem>
                            <asp:ListItem>$6.00</asp:ListItem>
                            <asp:ListItem>$6.50</asp:ListItem>
                            <asp:ListItem>$7.00</asp:ListItem>
                        </asp:DropDownList>
                         <asp:DropDownList ID="cash_recieved_ddl" runat="server" Visible="false" Font-Size="X-Large">
